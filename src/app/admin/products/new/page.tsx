...
export default function NewProductPage() {
  ...
  // Carrega planos da SyncPay
  useEffect(() => {
    fetch('/api/syncpay/plans')
      .then((r) => r.json())
      .then(({ plans, error }) => {
        if (error) setPlansError(error);
        else setPlans(plans ?? []);
      })
      .catch(() => setPlansError('Erro ao carregar planos da SyncPay'))
  ...
  async function handleSubmit(e: FormEvent) {
    ...
    try {
      ...
      setSaveError('Erro de conexão ao salvar o produto');
    } finally {
      setSaving(false);
    }
  }
    ...
    <div className="admin-page-container">
      ...
      <div className="page-header">
        <div>
          ...
          <p className="page-subtitle">Configure seu grupo VIP e atrele um plano da SyncPay</p>
        </div>
      ...
      <form onSubmit={handleSubmit} className="form-layout">
        ...
        <div className="form-card">
          ...
          <div className="grid-2">
            ...
            <div className="field-group">
              <div className="flex-between">
                <label className="field-label">URL do Produto (Slug AUTO)</label>
                {isSlugCustomized && (
                  <button
                    type="button"
                    className="btn-link"
              ...
              <span className="field-help">Preenchido automaticamente ao digitar o nome</span>
            </div>
          </div>
          ...
          <div className="field-group mt-4">
            ...
            <textarea
              ...
              placeholder="Ex: Grupo privado exclusivo da Sarinha, apenas para os mais próximos..."
        ...
        <div className="form-card">
          ...
          {plansLoading ? (
            ...
            <div className="alert-mono warning">
              <span>Nenhum plano encontrado na SyncPay. Crie um plano no painel da SyncPay primeiro.</span>
            </div>
          ) : (
            ...
            <div className="toggles-list">
              ...
              >
                <div className="toggle-meta">
                  ...
                  <span className="toggle-sub">Mostra o valor monetário da assinatura no checkout</span>
                </div>
